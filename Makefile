...
# example.com/airflow-helm-operator-bundle:$VERSION and example.com/airflow-helm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/opdev/airflow-helm-operator
